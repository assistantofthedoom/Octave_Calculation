...
for n=1:number_signal_angle
	...
	radiation_pattern_log = 10 * log10(radiation_pattern);

	[max_power_value , max_power_pos] = max(radiation_pattern_log);
	...
	plot(omnidirectionnal_data(:,1) * 180 / pi,radiation_pattern_log);
