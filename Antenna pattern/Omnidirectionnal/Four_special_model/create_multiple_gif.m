...
antenna_2_y_pos = 0;
	antenna_2_enable = 0;
	antenna_2_enable_phase = 0;

antenna_3_x_pos = -33;
antenna_3_y_pos = -13;
	antenna_3_enable = 1;
	antenna_3_enable_phase = 1;

antenna_4_x_pos = 34;
antenna_4_y_pos = -13;
	antenna_4_enable = 0;
	antenna_4_enable_phase = 0;
...
if (antenna_1_enable == 1 && antenna_1_enable_phase == 1)
	angle_offset_1 = linspace(phase_start,phase_final,number_step);
else
	angle_offset_1 = 0;
endif

if (antenna_2_enable == 1 && antenna_2_enable_phase == 1)
	angle_offset_2 = linspace(phase_start,phase_final,number_step);
else
	angle_offset_2 = 0;
endif

if (antenna_3_enable == 1 && antenna_3_enable_phase == 1)
	angle_offset_3 = linspace(phase_start,phase_final,number_step);
else
	angle_offset_3 = 0;
endif

if (antenna_4_enable == 1 && antenna_4_enable_phase == 1)
	angle_offset_4 = linspace(phase_start,phase_final,number_step);
else
	angle_offset_4 = 0;
endif
...
for i = angle_offset_1
	for j = angle_offset_2
		for k = angle_offset_3
			for l = angle_offset_4

				radian_offset_1 = i * pi / 180;
				radian_offset_2 = j * pi / 180;
				radian_offset_3 = k * pi / 180;
				radian_offset_4 = l * pi / 180;
				...
				for n = 1:number_of_step
					...
					for i2=1:number_of_points
						...
						if (mesh_antenna_value(i2,j2) > minimum_value)
