...
filename = ["mesh_antenna" , "-" , num2str(angle_offset_1) , "-" , num2str(angle_offset_2) , "-" , num2str(angle_offset_3) , "-" , num2str(angle_offset_4) , "-" , num2str(angle_offset_5) , ".gif"];
...
for n = 1:number_of_step
	...
	mesh_antenna_value = mesh_antenna_1_value + mesh_antenna_2_value + mesh_antenna_3_value + mesh_antenna_4_value + mesh_antenna_5_value;
	...
	text_title = ["angle-" , num2str(n * multi) , "-" , num2str(angle_offset_1) , "-" , num2str(angle_offset_2) , "-" , num2str(angle_offset_3) , "-" , num2str(angle_offset_4) , "-" , num2str(angle_offset_5) ];
