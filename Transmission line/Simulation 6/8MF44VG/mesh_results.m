...
for i=1:number_of_connexion_names
	title_of_meshes_max_value(i,:) = [ connexion_names(i,:) , ' 8MF44VG - maximum related to length' ];
	title_of_meshes_max_pos(i,:) = [ connexion_names(i,:) , ' 8MF44VG - frequency related to length' ];
	title_of_meshes_min_value(i,:) = [ connexion_names(i,:) , ' 8MF44VG - minimum related to length' ];
	title_of_meshes_min_pos(i,:) = [ connexion_names(i,:) , ' 8MF44VG - frequency related to length' ];
	title_of_meshes_fixed(i,:) = [ connexion_names(i,:) , ' 8MF44VG - 3,5 GHz value related to length' ];
endfor
